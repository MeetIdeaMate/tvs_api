...
public class StatementSummaryController {
    ...
    @GetMapping
    public ResponseEntity getStatementSummary(@RequestParam String statementId, @RequestParam(required = false) AccountType accountType, @RequestParam(required = false) String accountHead){
        BankStatementSummary bankStatementSummary = statementSummaryService.getStatementSummary(statementId,accountType,accountHead);
    ...
    public ResponseEntity updateStatementSummary(@PathVariable String statementId,@RequestBody StatementSummaryUpdateReq statementSummaryUpdateReq){
         statementSummaryService.updateStatementSummary(statementId,statementSummaryUpdateReq);
